...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/514.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
...
<li id="menu-item-568" class="menu-item menu-item-type-post_type menu-item-object-service menu-item-568"><a href="../service/helium-leak-detector-and-cold-head-exchange/index.php">Helium leak detection, coldhead exchange, repairs and rigging tool rental</a></li>
					...
					<div class="col-md-3 col-lg-3 col-sm-3 footLinks">
						<h4>Legals</h4>
						<div class="menu-legal-menu-container"><ul id="menu-legal-menu" class=""><li id="menu-item-519" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-514 current_page_item menu-item-519"><a href="index.php" aria-current="page">Privacy Policy</a></li>

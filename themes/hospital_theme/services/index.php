...
<li><a href="javascript:;"><i class="fab fa-instagram"></i></a></li> -->
		...
		<section class="master_page">
			...
			<div class="container">
				...
				<div class="vc_row wpb_row vc_row-fluid vc_custom_1549538232799">
					<div class="wpb_column vc_column_container vc_col-sm-12">
						<div class="vc_column-inner ">
							<div class="wpb_wrapper">
								<h2 style="text-align: center" class="vc_custom_heading wpb_animate_when_almost_visible wpb_zoomIn zoomIn vc_custom_1549017875033">OUR SERVICES</h2>
								<div class="wpb_text_column wpb_content_element ">
									<div class="wpb_wrapper">
										...
										<style>
											...
											/* OUR SERVICES AREA */
											/*=====================================*/
											.serviceTitlePageWrapper .services-listing .services-box {
												margin-bottom: 30px;
												position: relative;
												transition: all .3s;
											}

											.serviceTitlePageWrapper .services-listing .services-box>.services-img,
											...
											.serviceTitlePageWrapper .services-listing .services-box>.services-img>img,
											...
											.serviceTitlePageWrapper .services-listing .services-box>.services-content-box {
												position: absolute;
												top: 0px;
												left: 0px;
												background: #0000007a;
											...
											.serviceTitlePageWrapper .services-listing .services-box:hover>.services-content-box {
												transition: all .3s;
												padding: 20px;
											}

											.serviceTitlePageWrapper .services-listing .services-box>.services-content-box .services-content-box-inner {
												border-radius: 10px;
												padding: 25px;
												height: 100%;
												overflow: hidden;
											...
											.serviceTitlePageWrapper .services-listing .services-box>.services-content-box h4.services-title {
												font-size: 18px;
												line-height: normal;
												letter-spacing: 1px;
												margin-bottom: 0px;
											...
											.serviceTitlePageWrapper .services-listing .services-box>.services-content-box h4.services-title>a {
												color: #fff;
												font-size: 16px;
											}
										</style>

...
================================================== -->
	...
	<link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/600" />
										...
										<script type="text/javascript">
											(function($) {
												...
												var opts = window.FlowFlowOpts || {
													...
													"lightbox_navigate": "Navigate with arrow keys",
													"view_on": "View on",
													...
													"server_time": 1786026968,
													"forceHTTPS": "nope",
													"isAdmin": false,
													"ajaxurl": "https:\/\/goringmedicalprojects.com\/wp-admin\/admin-ajax.php",
													"isLog": false,
													"plugin_base": "https:\/\/goringmedicalprojects.com\/wp-content\/plugins\/flow-flow",
													"plugin_ver": "4.6.17"
												};
												...
												var streamOpts = {
													...
													"feeds": [{
														...
														"status": "1",
														"enabled": "yep",
														"last_update": "Aug 6 14:10",
														"cache_lifetime": "60",
														"system_enabled": "1",
														"boosted": "nope",
														"timeline-type": "page_timeline",
														"content": "Goring Medical Projects",
														"posts": "10",
														"mod": "nope",
														"type": "facebook",
														"include": "",
												...
												if (streamOpts.layout == 'carousel') {
													...
													/*the same with list, we only need news feed style*/
